...
# This Draw will run automatically
def draw():
...
# This Update will update the stars
def update():
  global stars
  if len(stars) == 0:
    stars = make_stars(current_level)

# This will get colors to create Stars
...
# This will create stars with given color
